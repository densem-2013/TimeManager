...
{
    public static Infocom.TimeManager.WebAccess.Controllers.IncomingRequestController IncomingRequest = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_IncomingRequestController();
    public static Infocom.TimeManager.WebAccess.Controllers.AccountController Account = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_AccountController();
    public static Infocom.TimeManager.WebAccess.Controllers.ContractsController Contracts = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_ContractController();
    public static Infocom.TimeManager.WebAccess.Controllers.EmployeeController Employee = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_EmployeeController();
    public static Infocom.TimeManager.WebAccess.Controllers.ErrorController Error = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_ErrorController();
    public static Infocom.TimeManager.WebAccess.Controllers.ProjectDetailsController ProjectDetails = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_ProjectDetailsController();
    public static Infocom.TimeManager.WebAccess.Controllers.ProjectsOverviewController ProjectsOverview = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_ProjectsOverviewController();
    public static Infocom.TimeManager.WebAccess.Controllers.RequestsController Requests = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_RequestsController();
    public static Infocom.TimeManager.WebAccess.Controllers.TaskController Task = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_TaskController();
    public static Infocom.TimeManager.WebAccess.Controllers.TimeRegistrationController TimeRegistration = new Infocom.TimeManager.WebAccess.Controllers.T4MVC_TimeRegistrationController();
...
namespace Links
{
    ...
    public static class Scripts
    {
        ...
        public static readonly string InfocomTools_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/InfocomTools.min.js") ? Url("InfocomTools.min.js") : Url("InfocomTools.js");
        ...
        public static readonly string jquery_betterTooltip_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.betterTooltip.min.js") ? Url("jquery.betterTooltip.min.js") : Url("jquery.betterTooltip.js");
    ...
    public static class Content
    {
        ...
        public static class Images
        {
            ...
            public static readonly string blockinform_png = Url("blockinform.png");
            public static readonly string footer_png = Url("footer.png");
            public static readonly string Infocom_Logo_png = Url("Infocom.Logo.png");
            public static readonly string left_border_png = Url("left_border.png");
            public static readonly string right_border_png = Url("right_border.png");
            public static readonly string submenu_png = Url("submenu.png");
            public static readonly string tophead_bg_png = Url("tophead_bg.png");
            public static readonly string tophead_left_jpg = Url("tophead_left.jpg");
            public static readonly string tophead_right_png = Url("tophead_right.png");
        }
