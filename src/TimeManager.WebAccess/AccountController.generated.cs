...
namespace Infocom.TimeManager.WebAccess.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: Infocom.TimeManager.WebAccess.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult LogOn(Infocom.TimeManager.WebAccess.Models.LogOnModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.LogOn);
